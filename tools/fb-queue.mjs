...
const HOOKS = {
  'nisan-lifi-chademo': [
    'საქართველოში 627 საჯარო დამტენია, CHAdeMO კონექტორი კი მხოლოდ 18-ს აქვს. სწორედ ეს კონექტორი აქვს ნისან ლიფს, ქვეყანაში ყველაზე ხშირად ნაყიდ ელექტრომობილს.\n\nსად დგას ეს 18 დამტენი და როგორ დავგეგმოთ გზა ლიფით.',
    '2026 წლის ახალ ნისან ლიფს CHAdeMO აღარ აქვს: ევროპაში CCS უდგას, ჩრდილოეთ ამერიკაში NACS. ძველი კონექტორი უკვე მხოლოდ იმ მანქანებზეა, რომლებიც გაყიდულია.\n\nრას ნიშნავს ეს საქართველოში დატენვისთვის.',
  ],
  'datenvis-kharjebi': [
